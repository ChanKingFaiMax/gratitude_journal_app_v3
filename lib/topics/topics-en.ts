...
/**
 * English topic database - 201 topics
 * Categories: people, relationship, food, moment, growth, sensory, memory, object, nature, daily, work, health, creativity, travel, family, tech, season, self_care, philosophy
 */
export const TOPICS_EN: DailyTopic[] = [
