...
export async function invokeLLM(params: InvokeParams): Promise<InvokeResult> {
  ...
  // Use custom thinking config if provided, otherwise use default
  if (params.thinking) {
  ...
  console.log('[LLM] Has API Key:', !!apiKey);
  ...
  console.log('[LLM] API call succeeded, response length:', JSON.stringify(result).length);
  return result;
}
